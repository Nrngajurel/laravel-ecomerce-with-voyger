...
class ProductController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $catofProduct= $product->catagories()->get();


        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'productCatagories','catofProduct'));
    }
...
//       dd($request->all());
        ...
        CatagoryProduct::where('product_id', $id)->delete();
        if($request->category){
            foreach (request()->category as $catagory){
                CatagoryProduct::create([
                    'product_id'=> $id,
